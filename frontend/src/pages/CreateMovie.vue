    <template>
        <BaseLayout>
            <div class="max-w-4xl mx-auto my-8 px-4">
                <h1 class="text-center font-bold text-3xl my-6">Film létrehozása</h1>
                ...
                <div class="bg-gray-300 rounded-lg p-4">
                    <div class="flex flex-col md:flex-row gap-4">
                        ...
                        <div class="w-full md:w-4/12">
                            <h2 class="text-center text-2xl font-semibold mb-2">Poszter</h2>
                        ...
                        <div class="w-full md:w-8/12 space-y-4">
                            ...
                            <div class="flex flex-col sm:flex-row gap-3 items-center">
                                <div class="flex-1">
                                    <label class="block text-lg font-semibold mb-2">Cím</label>
                                    <FormKit type="text" v-model="movieTitle"
                                        input-class="w-full p-2 rounded-lg border-2 border-pink-300" />
                                </div>

                                <div class="w-24 sm:w-28">
                                    <label class="block text-lg font-semibold mb-2 text-center">Hossz (perc)</label>
                            ...
                            <div>
                                <label class="block text-lg font-semibold mb-2">Leírás</label>
                    ...
                    <div class="mt-4 grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        <div>
                            <h3 class="text-center text-xl font-semibold mb-2">Megjelenés</h3>
                            <input type="date" v-model="movieReleaseDate"
                                class="w-full p-2 rounded-lg border-2 border-pink-300 text-lg" />
                        </div>

                        <div>
                            <h3 class="text-center text-xl font-semibold mb-2">Műfaj</h3>
                            <select v-model="movieType" class="w-full p-2 rounded-lg border-2 border-pink-300">
                        ...
                        <div>
                            <h3 class="text-center text-xl font-semibold mb-2">Rendező</h3>
                    ...
                    <div class="mt-4">
                        <h3 class="text-center text-2xl font-semibold mb-2">Színészek</h3>

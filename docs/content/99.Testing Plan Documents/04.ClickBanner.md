...
- **A dokumentum megfelel a Movies - Tesztterv.docx hivatalos mintának.**

---

**További fejlesztői QA vagy Markdown export# Cinema Road – **Slider komponens** Selenium IDE Tesztterv

---

## I. TESZTELÉS CÉLJA

A Cinema Road főoldali carousel (slider) komponensének Selenium IDE automatizált tesztelése. A cél, hogy minden lényeges funkció (slider betöltés, kép, cím, leírás, gombok, automata és manuális váltás, dot-navigáció, böngésző zárás) stabilan működjön a projekt követelményeinek megfelelően.
...
## III. TESZTESETEK RÖVID LEÍRÁSOKKAL

| Teszt azonosító                    | Kind      | Type        | Suite                | Testcase                             | Description                                                                                                             | Elvárt eredmény                                     | Dependency |
|-------------------------------------|-----------|-------------|----------------------|--------------------------------------|------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|------------|
| 01.Can_Open_Slider_Component        | Automated | Acceptance  | NavigationTests      | Can_Open_Slider_Component            | A főoldali slider komponens (carousel) megjelenik és betölt a weboldalon.                                              | Carousel megjelenik a főoldalon.                    | N/A        |
| 02.Verify_First_Slide_Image_And_Title| Automated| Component   | ContentVerification  | Verify_First_Slide_Image_And_Title   | Az első slide aktív állapotban megfelelő képet és h3 címet (“A galaxis őrzői vol. 3”) mutat.                           | Kép és h3 cím jelenik meg.                          | N/A        |
| 03.Verify_First_Slide_Description   | Automated | Component   | ContentVerification  | Verify_First_Slide_Description       | Az első slideren a leírás pontosan: „Premier előtti vetítés!” szöveg jelenik meg p tagben.                              | Pontos leírás szöveg.                               | N/A        |
| 04.Prev_Button_Disabled_On_First_Slide|Automated| Other       | UserInteractionTests | Prev_Button_Disabled_On_First_Slide  | Az első slide-on az előző/balra gomb (button) tiltott, helyes Tailwind disable class-szal (pl. .opacity-40).           | Gomb nem kattintható, szürke.                       | N/A        |
| 05.Next_Slide_Click_By_ExecuteScript| Automated | Other       | UserInteractionTests | Next_Slide_Click_By_ExecuteScript    | Következő slide-ra csak JavaScript (executeScript) click működik Selenium IDE-ben; kattintás után a következő slide (“Dűne”) aktív lesz.           | „Dűne” cím megjelenik.                              | N/A        |
| 06.Dot_Indicator_Navigation         | Automated | Other       | UserInteractionTests | Dot_Indicator_Navigation             | **Dot indikátorra (pl. 3.) csak executeScript JS click működik. Az assertText itt nem minden környezetben automata; a váltást QA manuális/screenshot ellenőrzéssel is igazolni kell!  Szükség esetén conditional pass jelzés megengedett.** | 3. dot után a 3. slide (“Star Wars: Az ébredő Erő”) aktiválódik. | N/A        |
| 07.Autoplay_Slide_Change            | Automated | Other       | UserInteractionTests | Autoplay_Slide_Change                | 4,5 másodperc után a slider magától átvált, az aktív h3 cím változik.                                                   | Slide automatikusan vált.                           | N/A        |
| 08.User_Can_Close_The_Window        | Automated | Acceptance  | NavigationTests      | User_Can_Close_The_Window            | Selenium IDE tesztsor végén a böngésző automatikusan bezáródik.                                                         | Böngésző zárul a sor végén.                         | N/A        |
...
- A Slider komponens Selenium IDE-vel, minimum 3 movies slide-dal tesztelhető.
- A dot indikátor (06) esetében a SeleniumIDE csak executeScript JS-click-kel tud slideot váltani: automatizált assertText kimenet bizonytalan, ezért manuális/screenshotos QA elfogadott.
- Minden végpont önálló parancs-sor, minden teszt végén close parancs.
- Tesztfutásokat dátummal és eredménnyel dokumentálni kell a riportban.

---

## VI. KÖVETKEZTETÉS ÉS JAVASLAT

- A Slider fő funkciói automatizáltan és/vagy manuális QA validációval tesztelhetők.
- JS-click, delay, QA screenshot az új frontendes komponensek standardjainak megfelelő workaround.
- A tesztterv dokumentum megfelel a Movies - Tesztterv.docx hivatalos mintájának.
- Az alkalmazott QA-protokollt (conditional pass, manual check) a projektcsapat számára írásban is ki kell hirdetni.

...
class MovieSeeder extends Seeder
{
    ...
    {
        $categoryTypes = [
            'Action' => 'storage/app/public/Action_Movies_img',
            'Family' => 'storage/app/public/Family_Movies_img',
            'Horror' => 'storage/app/public/Horror_Movies_img',
            'Default' => 'storage/app/public/Default',
        ];
    ...
    public function staticMoviesData(string $movieType, string $basePathToImgs)
    {
        return match ($movieType) {
            ...
            'Family' => [
                ...
                ["title" => "A Házikó a Fán", "description" => "Két testvér egy rejtett fára épített házikót talál, ami ajtót nyit egy másik világba. Ám ahhoz, hogy hazajussanak, előbb meg kell menteniük egy mesebeli birodalmat.", "poster_url" => $basePathToImgs . '/Haziko_a_fan.jpg'],
                ...
                ["title" => "Tündérek Titkai", "description" => "Egy kíváncsi kislány rábukkan egy régi hídra, amit tündérek őriznek. A mese életre kel, mikor az álom és valóság határai összemosódnak.", "poster_url" => $basePathToImgs . '/A_Tunderek_titkai.jpg'],
                ["title" => "Apa, hol a Nap?", "description" => "Amikor a Nap eltűnik az égről, egy kislány és apukája egy varázslatos utazásra indulnak, hogy visszahozzák a fényt a világnak – és egymás szívébe.", "poster_url" => $basePathToImgs . '/Apa_hol_a_nap.jpg'],
            ],
            ...
            default => [
                ["title" => "Film címe hibás", "description" => "Film leírása hibás", "poster_url" => $basePathToImgs . '/img_not_found.jpg'],
            ],
        };
    }
}
